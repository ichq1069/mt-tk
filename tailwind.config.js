    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                rainbow: {
                    red: 'hsl(var(--rainbow-red) / <alpha-value>)',
                    orange: 'hsl(var(--rainbow-orange) / <alpha-value>)',
                    amber: 'hsl(var(--rainbow-amber) / <alpha-value>)',
                    emerald: 'hsl(var(--rainbow-emerald) / <alpha-value>)',
                    cyan: 'hsl(var(--rainbow-cyan) / <alpha-value>)',
                    blue: 'hsl(var(--rainbow-blue) / <alpha-value>)',
                    indigo: 'hsl(var(--rainbow-indigo) / <alpha-value>)',
                    violet: 'hsl(var(--rainbow-violet) / <alpha-value>)',
                    fuchsia: 'hsl(var(--rainbow-fuchsia) / <alpha-value>)',
                    pink: 'hsl(var(--rainbow-pink) / <alpha-value>)'
                }
            },
            borderRadius: {
                lg: 'var(--radius)',
