DROP FUNCTION IF EXISTS public.get_web_vitals_stats(text, integer);

CREATE OR REPLACE FUNCTION public.get_web_vitals_stats(p_metric_name text DEFAULT NULL, p_days integer DEFAULT 7)
