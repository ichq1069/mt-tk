-- 修复 upsert_user_visit_stats 函数的 device/device_type 列名不匹配问题（带错误捕获）
DO $$ 
DECLARE 
    r RECORD;
BEGIN
...
BEGIN
    ...
    BEGIN
        ...
        VALUES (
            ...
            upsert_user_visit_stats.device,  -- 参数名是 device，但插入到 device_type 列
            ...
            upsert_user_visit_stats.visited_at
        );
    END;
