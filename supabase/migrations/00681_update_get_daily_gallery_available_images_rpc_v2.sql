CREATE OR REPLACE FUNCTION public.get_daily_gallery_available_images_rpc(p_limit integer, p_offset integer, p_search text DEFAULT NULL::text, p_status text DEFAULT 'unused'::text)
