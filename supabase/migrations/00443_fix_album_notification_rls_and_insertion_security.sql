-- Update existing status change trigger to SECURITY DEFINER
...
BEGIN
  ...
  RETURN NEW;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER; -- Add SECURITY DEFINER to bypass RLS

-- Update request submission trigger to SECURITY DEFINER
