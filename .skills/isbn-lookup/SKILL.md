...
- **Endpoint**：`POST https://app-b5vwlh6eky69-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-b5vwlh6eky69-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
